...
public class GuestbookPersistenceImpl extends BasePersistenceImpl<Guestbook>
	...
	private static final String _FILTER_SQL_SELECT_GUESTBOOK_WHERE = "SELECT DISTINCT {guestbook.*} FROM guestbook_Guestbook guestbook WHERE ";
	private static final String _FILTER_SQL_SELECT_GUESTBOOK_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {guestbook_Guestbook.*} FROM (SELECT DISTINCT guestbook.guestbookId FROM guestbook_Guestbook guestbook WHERE ";
	private static final String _FILTER_SQL_SELECT_GUESTBOOK_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN guestbook_Guestbook ON TEMP_TABLE.guestbookId = guestbook_Guestbook.guestbookId";
	private static final String _FILTER_SQL_COUNT_GUESTBOOK_WHERE = "SELECT COUNT(DISTINCT guestbook.guestbookId) AS COUNT_VALUE FROM guestbook_Guestbook guestbook WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "guestbook";
	private static final String _FILTER_ENTITY_TABLE = "guestbook_Guestbook";
	private static final String _ORDER_BY_ENTITY_ALIAS = "guestbook.";
	private static final String _ORDER_BY_ENTITY_TABLE = "guestbook_Guestbook.";
