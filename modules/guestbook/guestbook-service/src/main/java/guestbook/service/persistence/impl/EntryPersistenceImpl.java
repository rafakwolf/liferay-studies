...
public class EntryPersistenceImpl extends BasePersistenceImpl<Entry>
	...
	private static final String _FILTER_SQL_SELECT_ENTRY_WHERE = "SELECT DISTINCT {entry.*} FROM guestbook_Entry entry WHERE ";
	private static final String _FILTER_SQL_SELECT_ENTRY_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {guestbook_Entry.*} FROM (SELECT DISTINCT entry.entryId FROM guestbook_Entry entry WHERE ";
	private static final String _FILTER_SQL_SELECT_ENTRY_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN guestbook_Entry ON TEMP_TABLE.entryId = guestbook_Entry.entryId";
	private static final String _FILTER_SQL_COUNT_ENTRY_WHERE = "SELECT COUNT(DISTINCT entry.entryId) AS COUNT_VALUE FROM guestbook_Entry entry WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "entry";
	private static final String _FILTER_ENTITY_TABLE = "guestbook_Entry";
	private static final String _ORDER_BY_ENTITY_ALIAS = "entry.";
	private static final String _ORDER_BY_ENTITY_TABLE = "guestbook_Entry.";
